...
const Visitor = () => {
  return (
    <div>
    <h4 className='pt-4'>Visitor Details</h4>
    <div className="visitor-flex-container m-4">
        <div className='flex justify-between'>
            ...
            <div className="rightside-visitor flex">
                <div className='visitor-search'>
                   <input type="text" className="form-control" id="input-text" placeholder="Enter Search Text" />
               </div>
                <Link to={`${import.meta.env.BASE_URL}pages/extraFeatures/createVisitor`} className="product-image">
                    ...
                    <div className="table-responsive">
                        <table className="table whitespace-nowrap table-sm min-w-full">
                            <thead><tr className="border-b border-defaultborder">
                                <th scope="col" className="text-start">Visitor Detail</th>
                                <th scope="col" className="text-start">Time In</th>
                                <th scope="col" className="text-start">Time Out</th>
                                <th scope="col" className="text-start">Purpose</th>
                                <th scope="col" className="text-start">Guests</th>
